...
(() => {
  ...
  const DEFAULTS = {
    ...
    excite: 0,    // Exciter
    mix: 0,       // Output Mix — starts at 0 (fully dry/bypassed). Paired with
                  // the master wet-chain bypass below, this means Cover adds
                  // ZERO audible effect and ZERO CPU cost until you raise
                  // this slider. Raise it to actually hear/engage Cover.
    enabled: true
  };
